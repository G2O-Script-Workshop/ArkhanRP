...
#public:
	...
	static function onMouseClick(button)
	{
		...
		if (elementPointedByCursor)
		{
			...
			elementPointedByCursor.call(EventType.MouseDown, elementPointedByCursor.m_lastButtonPressed)
	...
	static function onMouseRelease(button)
	{
		if (elementPointedByCursor)
		{
			elementPointedByCursor.call(EventType.MouseUp, elementPointedByCursor.m_lastButtonPressed)
			...
			if (elementPointedByCursor.m_lastButtonPressed == MOUSE_LMB) {
				elementPointedByCursor.call(EventType.Click)

class GUI.Note extends classes(GUI.Texture, GUI.Margin, GUI.Alignment)
{
#private:
...
#public:
	...
	static function onChange(self)
	{
		...
		if (!(self instanceof GUI.ScrollBar) || !(parent instanceof GUI.Note))
		{
			return
		}
...
addEventHandler("GUI.onChange", GUI.Note.onChange)

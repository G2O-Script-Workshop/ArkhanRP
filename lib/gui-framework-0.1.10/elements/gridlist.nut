...
#public:
	...
	constructor(x, y, w, h, bodyBg, scrollBg, scrollIndicator, scrollIncreaseBtn, scrollDecreaseBtn, window = null)
	{
		...
		scrollbar = GUI.ScrollBar(x + w - anx(SCROLLBAR_SIZE), y, anx(SCROLLBAR_SIZE), h, scrollBg, scrollIndicator, scrollIncreaseBtn, scrollDecreaseBtn, Orientation.Vertical)
	...
	function setPositionPx(x, y)
	{
		...
		scrollbar.setPositionPx(x + getSizePx().width - SCROLLBAR_SIZE, y)

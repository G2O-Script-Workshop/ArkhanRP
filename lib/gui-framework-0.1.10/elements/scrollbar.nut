...
#public:
	...
	static function onClick(self)
	{
		...
		if (!(scrollbar instanceof GUI.ScrollBar))
			return

		if (scrollbar.m_orientation == Orientation.Horizontal)
			activeHorizonalScrollBar = scrollbar
		else if (scrollbar.m_orientation == Orientation.Vertical)
...
addEventHandler("GUI.onClick", GUI.ScrollBar.onClick)
